...
##### Files setting and import * ##### 
  ## File setting*
  RNAFileName <- "TCGA_PAAD_HiSeqV2" # RNAFileName <- "TCGA_PAAD_HiSeqV2"
  CNVFileName <- "TCGA_Gistic2_CopyNumber_Gistic2_all_data_by_genes"
  PhenoFileName <- "TCGA-PAAD.GDC_phenotype.tsv"

##### Conditions setting* ##### 
  Target_gene_name <- "TOP2A" # ENSG00000131747 TOP2A
...
##### Primary CNV Heatmap #####  
  ...
  col_fun = colorRamp2(c(-2, 0, 2), # c(-1, 0, 1)
                       c( "#02994d","#0c1829", "#e81c4b"))
